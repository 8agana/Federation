#!/usr/bin/env python3
"""
DT Federation RAG V2 MCP Server Runner - Specialized Tools Edition
"""
import sys
import os
...
if __name__ == "__main__":
    ...
    try:
        # Import and run the V2 DT server
        from dt_federation_rag_v2 import mcp
        
        # Log startup info to stderr
        sys.stderr.write("\n🚀 Starting DT Federation RAG V2 MCP Server - Specialized Tools Edition\n")
        ...
        sys.stderr.write(f"❌ Failed to start DT V2 server: {e}\n")
        import traceback
